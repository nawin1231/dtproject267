 ...
 <?php include_once("includes/sidebar.php");?>
  ...
  <div class="content-wrapper">
   ...
   <div class="form-group">
                    <label for="exampleInputFullname">ชื่อของเรือ</label>
                    <input type="text" class="form-control" id="boatname" name="boatname" placeholder="Enter Name of Boat" required>
                  </div>

 <div class="form-group">
                    <label for="exampleInputFullname">รูปประกอบ</label>
                    <input type="file" class="form-control" id="image" name="image" required>
                  </div>
                   <div class="form-group">
                    <label for="exampleInputFullname">ขนาดเรือ</label>
                    
                    <select class="form-control" name="size" required>
                      <option value="">เลือกขนาดเรือ</option>
